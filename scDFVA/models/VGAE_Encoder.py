...
class VGAE_Encoder(nn.Module):
    ...
    def forward(self, x, edge_index):
        ...
        return z_mean, z_log_std, (attn_w_1, attn_w_2, attn_w_mean, attn_w_log_std), hidden_out1, hidden_out2


class VGAE_GCNEncoder(nn.Module):
    def __init__(self, num_hidden_layers, in_channels, hidden_dims, latent_dim):
        super(VGAE_GCNEncoder, self).__init__()
        assert (num_hidden_layers == 2 or num_hidden_layers == 3), 'The number of hidden layers must be 2 or 3.'
    ...
    def forward(self, x, edge_index):
        ...
        return z_mean, z_log_std, hidden_out1, hidden_out2